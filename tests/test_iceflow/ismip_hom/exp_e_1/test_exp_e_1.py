...
def test_exp_e_1_unified(
    ...
    # Reference results
    path_file_ref = os.path.join("..", "data", "oga", "oga1e000.txt")
    try:
    ...
    # Plot
    title = f"ISMIP-HOM | EXP-E-1 | unified/{mapping}/{optimizer}"
    filename = f"exp_e_1_unified_{mapping}_{optimizer}.pdf"
