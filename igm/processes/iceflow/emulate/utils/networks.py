...
class UNET_inital(tf.keras.Model):
    def __init__(self, cfg, nb_inputs, nb_outputs, input_normalizer=None):
        ...
        # Encoder
        self.enc_conv1 = tf.keras.layers.Conv2D(
            nb_filters,
            3,
            padding="same",
            activation=activation,
        ...
        self.enc_conv2 = tf.keras.layers.Conv2D(
            nb_filters,
            3,
            padding="same",
            activation=activation,
        ...
        self.pool1 = tf.keras.layers.Conv2D(
            nb_filters,
            3,
            strides=2,
            padding="same",
        ...
        self.enc_conv3 = tf.keras.layers.Conv2D(
            nb_filters * 2,
            3,
            padding="same",
            activation=activation,
        ...
        self.enc_conv4 = tf.keras.layers.Conv2D(
            nb_filters * 2,
            3,
            padding="same",
            activation=activation,
        ...
        self.pool2 = tf.keras.layers.Conv2D(
            nb_filters * 2,
            3,
            strides=2,
            padding="same",
        ...
        # Bottleneck
        self.bottleneck1 = tf.keras.layers.Conv2D(
            nb_filters * 4,
            3,
            padding="same",
            activation=activation,
        ...
        self.bottleneck2 = tf.keras.layers.Conv2D(
            nb_filters * 4,
            3,
            padding="same",
            activation=activation,
        ...
        self.dec_conv1 = tf.keras.layers.Conv2D(
            nb_filters * 2,
            3,
            padding="same",
            activation=activation,
        ...
        self.dec_conv2 = tf.keras.layers.Conv2D(
            nb_filters * 2,
            3,
            padding="same",
            activation=activation,
        ...
        self.dec_conv3 = tf.keras.layers.Conv2D(
            nb_filters,
            3,
            padding="same",
            activation=activation,
        ...
        self.dec_conv4 = tf.keras.layers.Conv2D(
            nb_filters,
            3,
            padding="same",
            activation=activation,
